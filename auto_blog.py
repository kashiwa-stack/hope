...
【文字装飾ルール】読者（お母さん）が読みやすいよう、以下を自然に使ってください：
- 重要な専門用語・ポイント → <strong>太字</strong>
- 特に伝えたいキーフレーズ（1文に1〜2箇所まで）→ <u>下線</u>
- 強調したい数字・チェックポイント → <span style="color:#e8632a;font-weight:bold;">オレンジ色太字</span>
- 安心・ポジティブな表現 → <span style="color:#2e8b57;">グリーン色</span>
- 使い過ぎ禁止：装飾は段落あたり最大2〜3箇所。多用すると逆に読みにくくなる
